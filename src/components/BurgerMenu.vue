<template>
    <div class="p-4">
        ...
        <ul v-if="clicked" class="menu bg-base-200 rounded-lg mt-4">
            <li>
                <router-link to="/" class="tooltip tooltip-right rounded-lg" data-tip="Home" :href="$route.fullPath">
            ...
            <li>
                <router-link class="tooltip tooltip-right rounded-lg" data-tip="Puzzles" to="/puzzle">
