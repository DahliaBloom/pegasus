<template>
    <div class="h-screen flex flex-col w-full sm:flex-row justify-center overflow-hidden">
        <div class="sm:basis-1/4 w-full flex flex-col sm:h-full p-2 sm:p-4 items-center">
            ...
            <div class="w-full flex flex-row">
                <a to="/" class="tooltip tooltip-right rounded-lg block sm:hidden" data-tip="Home"
                    @click="$router.push('/')">
