import{_ as D,b as s,c as r,g as a,t as g,y,z as v,A as R,B as z,q as E,h as b,i as B,k as G,F as C,p as u}from"./index-985a36da.js";import{c as L,C as M}from"./chess-d99999e1.js";import"./_commonjsHelpers-725317a4.js";let m,x=0,O=null,k="";console.log("Starting stockfish");Stockfish().then(e=>{e.addMessageListener(P),e.postMessage("uci"),e.postMessage("setoption name use nnue value true"),e.postMessage("setoption name Threads value 16"),e.postMessage("setoption name Hash value 128"),e.postMessage("setoption name UCI_AnalyseMode value true"),e.postMessage("ucinewgame"),m=e,console.log("Stockfish started")});function P(e){if(console.log(e),e.startsWith("info depth")){const N=/ cp (-?\d+)/.exec(e);if(N===null){const f=/score mate (\d+)/.exec(e);x=parseFloat(f[1])*100}else x=parseFloat(N[1])/100;const c=/ pv (.+)/.exec(e);console.log("bestmove: "+c[1]),console.log("Pegasus Final Score: "+x),k.split(" ")[1]=="w"?O(x,c[1]):O(-x,c[1])}}async function w(e,n){m===void 0&&n(0,"stockfish undefined"),k=e,m.postMessage(`position fen ${e}`),m.postMessage("go movetime 1000"),O=n}const V={props:{evaluation:{type:Number,required:!0}},data(){return{height:50,heightString:"50%"}},methods:{update(){if(this.heightString=this.height+"%",console.log("update"),this.evaluation==="0.0"||this.evaluation==="0"){this.height=50,this.heightString=this.height+"%";return}let e=Number(this.evaluation);if(console.log("TMP:"+e),e>=100){this.height=100,this.heightString="100%";return}if(e<-100){this.height=0,this.heightString="0%";return}e>0&&(Math.abs(e)<1?(this.height=50+e*10,console.log("-1< x <1")):Math.abs(e)<3?(this.height=50+e*8,console.log("-3< x <3")):Math.abs(e)<6?(this.height=70+e*2,console.log("-6< x <6")):Math.abs(e)<11?(this.height=80+e,console.log("-9< x <9")):e>11&&(this.height=50+Math.log(Math.abs(e))*30)),e<0&&(Math.abs(e)<1?(this.height=50+e*10,console.log("-1< x <1")):Math.abs(e)<3?(this.height=50+e*8,console.log("-3< x <3")):Math.abs(e)<6?(this.height=30+e*2,console.log("-6< x <6")):Math.abs(e)<11?(this.height=20+e,console.log("-9< x <9")):e<-11&&(this.height=50-Math.log(Math.abs(e))*30)),this.height>96&&(this.height=96),this.height<4&&(this.height=4),this.heightString=this.height+"%"}},beforeMount(){this.update()},updated(){this.update()}},A=()=>{y(e=>({"319601e2":e.heightString}))},p=V.setup;V.setup=p?(e,n)=>(A(),p(e,n)):A;const I=e=>(v("data-v-2071d0eb"),e=e(),R(),e),F={class:"w-18 h-full flex flex-row flex-none m-2 items-center"},T={class:"mr-2 w-12 p-2"},H=I(()=>a("div",{class:"w-4 h-full relative flex-none rounded-lg"},[a("div",{class:"bg-black text-white text-center font-bold h-full rounded-lg"},[a("div",{class:"bg-white w-full text-center text-black absolute bottom-0 left-0 evalWhite rounded-b-lg transition-transform"})])],-1));function W(e,n,N,i,c,d){return s(),r("div",F,[a("span",T,g(this.evaluation),1),H])}const _=D(V,[["render",W],["__scopeId","data-v-2071d0eb"]]),Z={props:{username:{type:String,required:!0},elo:{type:String,required:!0},color:{type:Boolean,required:!0}},data(){return{user:{name:"N",avatar:"/src/assets/magnusCarlsen.png"}}},beforeMount(){L.getPlayer(this.username).then(e=>{this.user=e.body}).catch(()=>{isError.value=!0}).finally(()=>{console.log(this.user)})}},j={class:"h-full w-full flex relative"},Y=["src"],J=["src"],U={class:"flex flex-row items-baseline"},$={class:"text-xl font-bold"},q={class:"text-xs px-3"};function X(e,n,N,i,c,d){return s(),r("div",j,[N.color?(s(),r("img",{key:0,class:"w-8 h-8 border-2 mr-2 rounded-lg",src:c.user.avatar,alt:"",style:{"border-color":"white"}},null,8,Y)):(s(),r("img",{key:1,class:"w-8 h-8 border-2 mr-2 rounded-lg",src:c.user.avatar,alt:"",style:{"border-color":"black"}},null,8,J)),a("div",U,[a("h2",$,g(c.user.username),1),a("p",q,g(this.elo),1)])])}const ee=D(Z,[["render",X]]),ae={props:{evaluation:{type:Number,required:!0}},data(){return{height:40,styleString:"background: conic-gradient(#F741B8 36deg 60deg, #475569 36deg); border-radius: 50%;"}},methods:{update(){this.height=this.evaluation,this.styleString="background: conic-gradient(#F741B8 36deg "+360*(this.height/100)+"deg, #475569 36deg); border-radius: 50%;"}},beforeMount(){this.update()},updated(){this.update()}},ie=a("div",{class:"h-12 w-12 bg-base-100 rounded-full"},null,-1),ne=[ie];function ce(e,n,N,i,c,d){return s(),r("div",{class:"h-20 w-20 m-2 flex items-center justify-center",style:z(c.styleString)},ne,4)}const de=D(ae,[["render",ce]]);function S(e){const N=`A00	Amar Gambit	1. Nh3 d5 2. g3 e5 3. f4 Bxh3 4. Bxh3 exf4
...
`).map(c=>c.trim());console.log(N),console.log(e);let i=[];for(const c of N){let f=c.split("	")[2].split(" ");f=f.filter(t=>!t.endsWith(".")),f.every((t,h)=>t===e[h])&&i.push({t:f,m:c.split("	")[1],a:c.split("	")[0][0]})}return console.log(i),i=={}?null:(i.sort(c=>{c.t.length}),i[i.length-1].a==["A"]&&(i[i.length-1].a=["Flank Attack"]),i[i.length-1].a==["B"]&&(i[i.length-1].a=["Semi-Open Game"]),i[i.length-1].a==["C"]&&(i[i.length-1].a=["Open Game"]),i[i.length-1].a==["D"]&&(i[i.length-1].a=["Closed Position"]),i[i.length-1].a==["E"]&&(i[i.length-1].a=["Indian Game"]),i[i.length-1])}const te={name:"CustomChessboard"},Ne={class:"chessboard w-[500px] h-[500px] bg-white"};function fe(e,n,N,i,c,d){return s(),r("div",Ne)}const oe=D(te,[["render",fe]]),se={created(){try{this.pgn=(E().query.pgn??void 0).toString(),console.log(this.pgn),this.chess.loadPgn(this.pgn),this.history=this.chess.history(),console.log(this.history),this.moves=[];let e=0;for(;e<this.history.length;)this.moves.push([this.history[e],this.history[e+1]]),e+=2;this.history=this.history.reverse(),this.chess.reset();const n=d=>{const t=/\[BlackElo "(.*?)"]/.exec(d);return t&&t.length>=2?t[1]:null};this.blackElo=n(this.pgn);const N=d=>{const t=/\[WhiteElo "(.*?)"]/.exec(d);return t&&t.length>=2?t[1]:null};this.whiteElo=N(this.pgn);const i=d=>{const t=/\[White "(.*?)"]/.exec(d);return t&&t.length>=2?t[1]:null};this.whitePlayer=i(this.pgn);const c=d=>{const t=/\[Black "(.*?)"]/.exec(d);return t&&t.length>=2?t[1]:null};this.blackPlayer=c(this.pgn)}catch{this.chess=null}},data(){return{fen:"",chess:new M,score:0,stockfish:null,custom:0,size:600,history:null,pgn:"",blackElo:"",whiteElo:"",blackPlayer:"",whitePlayer:"",positionInfo:null,stockfishWorking:!1,opening:{m:"Startin Position",t:[],a:[]},bestmove:"",moves:[],historyStack:[],board:null}},methods:{evaluatePosition(){console.log("evaluating!"+this.fen),w(this.fen,(e,n)=>{console.log("Received score:"+e),console.log("Received Bestmove:"+n),this.score=e,(this.bestmove==""||this.bestmove.length<=n.length||this.bestmove.split(" ")[0]!=n.split(" ")[0])&&(this.bestmove=n)}),setTimeout(()=>{this.stockfishWorking=!1,console.log("back!")},1e3)},onMovePlayed({move:e,game:n}){n.makeMove(e),console.log("FEEEEEEEEEEEEEEEEEEN:"+n.fen),this.fen=n.fen,this.opening=S(this.chess.history()),this.evaluatePosition()},moveCall(){if(console.log("moveCall"),console.log(this.chess.isGameOver()),!this.chess.isGameOver()&&!this.stockfishWorking){this.stockfishWorking=!0,console.log(console.log(this.history));let e=this.history.pop();this.chess.move(e),this.historyStack.push(e),this.fen=this.chess.fen(),this.opening=S(this.chess.history()),this.evaluatePosition()}},backMove(){console.log(this.historyStack),!this.stockfishWorking&&this.historyStack.length!=0&&(this.stockfishWorking=!0,this.chess.undo(),this.history.push(this.historyStack.pop()),this.fen=this.chess.fen(),this.evaluatePosition())},completeBack(){if(!this.stockfishWorking){for(;this.chess.fen()!="rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1";)this.chess.undo(),this.history.push(this.historyStack.pop()),this.fen=this.chess.fen();this.stockfishWorking=!0,this.evaluatePosition()}},completeEnd(){if(!this.stockfishWorking){for(;this.history.length!=0;)this.historyStack.push(this.history.pop());this.chess.loadPgn(this.pgn),this.fen=this.chess.fen()}}},components:{EvalBar:_,UserAnalyzeBar:ee,EvalCircle:de,CustomChessboard:oe}},re={key:0,class:"grid place-content-center min-h-screen text-secondary font-mono"},Be={key:1,class:"flex items-center overflow-hidden h-screen w-full flex-row py-8"},ge=a("div",{class:"basis-1/12 h-full"},null,-1),le={class:"flex flex-row h-full items-center basis-2/3 w-full"},be={class:"h-full flex flex-col"},xe={class:"bg-base-300 w-full h-full basis-1/12 py-2 px-2 border-solid border-secondary border-2 my-2 overflow-hidden rounded-lg"},De={class:"bg-base-300 w-full h-full basis-1/12 py-2 px-2 border-solid border-secondary border-2 my-2 overflow-hidden rounded-lg"},me={class:"mx-4 h-full w-fit border-2 border-secondary flex flex-col items-center justify-center bg-base-200 rounded-lg"},he={class:"grid grid-rows-3 w-full h-full place-items-center"},Oe=a("div",{class:"w-16 mx-4 h-0 border border-secondary"},null,-1),Ve={class:"grid grid-rows-3 h-full w-full place-items-center"},Ge={class:"h-full w-full bg-base-100 m-2 flex flex-col"},Ce=a("div",{class:"w-full h-1/3 p-2"},[a("div",{class:"bg-primary border-8 rounded-lg h-full w-full"})],-1),ue={class:"w-full h-1/4 p-2"},Ae={class:"bg-base-300 rounded-lg h-full w-full p-2 overflow-hidden"},pe=a("br",null,null,-1),Se={class:"badge badge-accent font-bold mr-2"},ke={class:"w-full h-1/2 p-2"},Qe={class:"bg-base-300 rounded-lg h-full w-full p-2 overflow-y-scroll items-center justify-center"},Ke={class:"w-full items-center justify-center"},ye={class:"my-2 grid grid-cols-2 gap-1 border border-slate-700 p-1 rounded-2xl"},ve={class:"flex justify-center"},Re={class:"badge bg-slate-300 text-slate-900 border-slate-900"},ze={class:"flex justify-center"},Ee={class:"badge bg-gray-800 text-gray-200 border-gray-200"},Le={class:"bottom-3 w-full h-12 grid grid-cols-5 gap-x-1"},Me={class:"btn-accent btn"},Pe={class:"btn-accent btn"},we=a("button",{class:"btn-accent btn"},[a("span",{class:"material-symbols-outlined"}," auto_awesome ")],-1),Ie={class:"btn-accent btn"},Fe={class:"btn-accent btn"};function Te(e,n,N,i,c,d){const f=b("EvalBar"),t=b("UserAnalyzeBar"),h=b("custom-chessboard"),l=b("EvalCircle"),Q=b("MoveTimeSlider");return this.chess===null?(s(),r("div",re," Invalide PGN ")):(s(),r("div",Be,[ge,a("div",le,[B(f,{ref:"evalBar",evaluation:c.score,class:"h-full"},null,8,["evaluation"]),a("div",be,[a("div",xe,[B(t,{color:!1,elo:this.blackElo,username:this.blackPlayer},null,8,["elo","username"])]),B(h),a("div",De,[B(t,{color:!0,elo:this.whiteElo,username:this.whitePlayer},null,8,["elo","username"])])]),a("div",me,[a("div",he,[B(l,{evaluation:90}),B(l,{evaluation:20}),B(l,{evaluation:40})]),Oe,a("div",Ve,[B(l,{evaluation:90}),B(l,{evaluation:20}),B(l,{evaluation:40})])]),a("div",Ge,[Ce,a("div",ue,[a("div",Ae,[G(g(c.opening.m)+" ",1),pe,(s(!0),r(C,null,u(c.opening.a,(o,K)=>(s(),r("div",{key:K},[a("div",Se,g(o),1)]))),128)),G(" "+g(c.bestmove),1)])]),B(Q,{class:"w-full"}),a("div",ke,[a("div",Qe,[(s(!0),r(C,null,u(c.moves,o=>(s(),r("div",Ke,[a("div",ye,[a("div",ve,[a("div",Re,g(o[0]),1)]),a("div",ze,[a("div",Ee,g(o[1]),1)])])]))),256))])]),a("div",Le,[a("button",Me,[a("span",{class:"material-symbols-outlined",onClick:n[0]||(n[0]=(...o)=>d.completeBack&&d.completeBack(...o))}," keyboard_double_arrow_left ")]),a("button",Pe,[a("span",{class:"material-symbols-outlined",onClick:n[1]||(n[1]=(...o)=>d.backMove&&d.backMove(...o))}," chevron_left ")]),we,a("button",Ie,[a("span",{class:"material-symbols-outlined",onClick:n[2]||(n[2]=(...o)=>d.moveCall&&d.moveCall(...o))}," chevron_right ")]),a("button",Fe,[a("span",{class:"material-symbols-outlined",onClick:n[3]||(n[3]=(...o)=>d.completeEnd&&d.completeEnd(...o))}," keyboard_double_arrow_right ")])])])])]))}const Ze=D(se,[["render",Te]]);export{Ze as default};
