var Qs=Object.defineProperty;var ws=(t,e,i)=>e in t?Qs(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var O=(t,e,i)=>(ws(t,typeof e!="symbol"?e+"":e,i),i);import{_ as Fe,b as j,c as $,g as S,t as he,y as Ps,z as Rs,A as Ls,B as Ks,k as on,F as Qa,p as wa,q as Es,h as je,i as se}from"./index-3240e59f.js";import{c as zs,C as Is}from"./chess-d99999e1.js";import"./_commonjsHelpers-725317a4.js";let Wi,ni=0,Gt=null,Pa="";console.log("Starting stockfish");Stockfish().then(t=>{t.addMessageListener(Fs),t.postMessage("uci"),t.postMessage("setoption name use nnue value true"),t.postMessage("setoption name Threads value 16"),t.postMessage("setoption name Hash value 128"),t.postMessage("setoption name UCI_AnalyseMode value true"),t.postMessage("ucinewgame"),Wi=t,console.log("Stockfish started")});function Fs(t){if(console.log(t),t.startsWith("info depth")){const i=/ cp (-?\d+)/.exec(t);if(i===null){const c=/score mate (\d+)/.exec(t);ni=parseFloat(c[1])*100}else ni=parseFloat(i[1])/100;const a=/ pv (.+)/.exec(t);console.log("bestmove: "+a[1]),console.log("Pegasus Final Score: "+ni),Pa.split(" ")[1]=="w"?Gt(ni,a[1]):Gt(-ni,a[1])}}async function rn(t,e){Wi===void 0&&e(0,"stockfish undefined"),Pa=t,Wi.postMessage(`position fen ${t}`),Wi.postMessage("go movetime 1000"),Gt=e}const Tt={props:{evaluation:{type:Number,required:!0}},data(){return{height:50,heightString:"50%"}},methods:{update(){if(this.heightString=this.height+"%",console.log("update"),this.evaluation==="0.0"||this.evaluation==="0"){this.height=50,this.heightString=this.height+"%";return}let t=Number(this.evaluation);if(console.log("TMP:"+t),t>=100){this.height=100,this.heightString="100%";return}if(t<-100){this.height=0,this.heightString="0%";return}t>0&&(Math.abs(t)<1?(this.height=50+t*10,console.log("-1< x <1")):Math.abs(t)<3?(this.height=50+t*8,console.log("-3< x <3")):Math.abs(t)<6?(this.height=70+t*2,console.log("-6< x <6")):Math.abs(t)<11?(this.height=80+t,console.log("-9< x <9")):t>11&&(this.height=50+Math.log(Math.abs(t))*30)),t<0&&(Math.abs(t)<1?(this.height=50+t*10,console.log("-1< x <1")):Math.abs(t)<3?(this.height=50+t*8,console.log("-3< x <3")):Math.abs(t)<6?(this.height=30+t*2,console.log("-6< x <6")):Math.abs(t)<11?(this.height=20+t,console.log("-9< x <9")):t<-11&&(this.height=50-Math.log(Math.abs(t))*30)),this.height>96&&(this.height=96),this.height<4&&(this.height=4),this.heightString=this.height+"%"}},beforeMount(){this.update()},updated(){this.update()}},dn=()=>{Ps(t=>({"319601e2":t.heightString}))},fn=Tt.setup;Tt.setup=fn?(t,e)=>(dn(),fn(t,e)):dn;const Ts=t=>(Rs("data-v-2071d0eb"),t=t(),Ls(),t),Hs={class:"w-18 h-full flex flex-row flex-none m-2 items-center"},Ws={class:"mr-2 w-12 p-2"},js=Ts(()=>S("div",{class:"w-4 h-full relative flex-none rounded-lg"},[S("div",{class:"bg-black text-white text-center font-bold h-full rounded-lg"},[S("div",{class:"bg-white w-full text-center text-black absolute bottom-0 left-0 evalWhite rounded-b-lg transition-transform"})])],-1));function $s(t,e,i,n,a,s){return j(),$("div",Hs,[S("span",Ws,he(this.evaluation),1),js])}const Ys=Fe(Tt,[["render",$s],["__scopeId","data-v-2071d0eb"]]),Zs={props:{username:{type:String,required:!0},elo:{type:String,required:!0},color:{type:Boolean,required:!0}},data(){return{user:{name:"N",avatar:"/src/assets/magnusCarlsen.png"}}},beforeMount(){zs.getPlayer(this.username).then(t=>{this.user=t.body}).catch(()=>{isError.value=!0}).finally(()=>{console.log(this.user)})}},Us={class:"h-full w-full flex relative"},Xs=["src"],qs=["src"],Js={class:"flex flex-row items-baseline"},ec={class:"text-xl font-bold"},ic={class:"text-xs px-3"};function tc(t,e,i,n,a,s){return j(),$("div",Us,[i.color?(j(),$("img",{key:0,class:"w-8 h-8 border-2 mr-2 rounded-lg",src:a.user.avatar,alt:"",style:{"border-color":"white"}},null,8,Xs)):(j(),$("img",{key:1,class:"w-8 h-8 border-2 mr-2 rounded-lg",src:a.user.avatar,alt:"",style:{"border-color":"black"}},null,8,qs)),S("div",Js,[S("h2",ec,he(a.user.username),1),S("p",ic,he(this.elo),1)])])}const nc=Fe(Zs,[["render",tc]]),ac={props:{evaluation:{type:Number,required:!0}},data(){return{height:40,styleString:"background: conic-gradient(#F741B8 36deg 60deg, #475569 36deg); border-radius: 50%;"}},methods:{update(){this.height=this.evaluation,this.styleString="background: conic-gradient(#F741B8 36deg "+360*(this.height/100)+"deg, #475569 36deg); border-radius: 50%;"}},beforeMount(){this.update()},updated(){this.update()}},sc=S("div",{class:"h-12 w-12 bg-base-100 rounded-full"},null,-1),cc=[sc];function oc(t,e,i,n,a,s){return j(),$("div",{class:"h-20 w-20 m-2 flex items-center justify-center",style:Ks(a.styleString)},cc,4)}const rc=Fe(ac,[["render",oc]]);function dc(t){const i=`A00	Amar Gambit	1. Nh3 d5 2. g3 e5 3. f4 Bxh3 4. Bxh3 exf4
