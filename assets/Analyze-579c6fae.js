...
`).map(a=>a.trim());let n=[];for(const a of t){let c=a.split("	")[2].split(" ");c=c.filter(o=>!o.endsWith(".")),c.every((o,r)=>o===i[r])&&n.push({t:c,m:a.split("	")[1],a:a.split("	")[0][0]})}return n.length==0?null:(n.sort(a=>{a.t.length}),n[n.length-1].a==["A"]&&(n[n.length-1].a=["Flank Attack"]),n[n.length-1].a==["B"]&&(n[n.length-1].a=["Semi-Open Game"]),n[n.length-1].a==["C"]&&(n[n.length-1].a=["Open Game"]),n[n.length-1].a==["D"]&&(n[n.length-1].a=["Closed Position"]),n[n.length-1].a==["E"]&&(n[n.length-1].a=["Indian Game"]),n[n.length-1])}const Gc={name:"chessyboardy"},Sc={class:"chessboard w-full h-full bg-white"};function yc(i,e,t,n,a,s){return I(),F("div",Sc)}const kc=He(Gc,[["render",yc]]),vc=["onKeyup"],_c={__name:"UCISender",setup(i){const e=hi("");function t(){Qi(e.value)}return(n,a)=>(I(),F(gi,null,[Ta(S("input",{type:"text",placeholder:"UCI command",class:"input w-full h-9 bg-slate-800 font-mono","onUpdate:modelValue":a[0]||(a[0]=s=>e.value=s),onKeyup:Xs(t,["enter"])},null,40,vc),[[Ha,e.value]]),S("button",{onClick:t,class:"bg-secondary h-fit min-w-fit rounded-full py-1 px-4 text-white"}," Send message ")],64))}},Mc={class:"rounded-lg bg-slate-800 flex-content"},wc={class:"scrollable-content-wrapper rounded-lg",id:"stockfishPanelSlider"},Qc=S("div",{class:"divider divider-horizontal"},null,-1),Pc={class:"font-mono",style:{"overflow-wrap":"anywhere"}},Rc={__name:"StockfishMessages",setup(i){return qs(Ot,()=>{let e=document.getElementById("stockfishPanelSlider");e.scrollTop=e.scrollHeight},{deep:!0,flush:"post"}),(e,t)=>(I(),F("div",Mc,[S("div",wc,[(I(!0),F(gi,null,Xi(Re(Ot),(n,a)=>(I(),F("div",{class:Wa(["flex space-x-3 items-center p-2",{"bg-slate-700":!n.stockfish}])},[S("div",null,ne(a),1),Qc,S("div",Pc,ne(n.msg),1)],2))),256))])]))}},Lc={class:"h-full w-full bg-base-300 rounded-lg p-5 flex justify-center items-center space-y-4 flex-col"},Kc={class:"flex space-x-2 h-fit w-full"},Ec={class:"w-full flex space-x-4"},zc={class:"min-w-fit"},Ic={class:"w-full"},Fc={class:"w-full flex space-x-4 items-center"},Tc={class:"w-full h-full"},Hc={__name:"StockfishPanel",setup(i){return(e,t)=>(I(),F("div",Lc,[S("div",Kc,[S("div",{class:Wa(["w-full h-fit text-white py-1 px-4 rounded-full text-center",[Re(ai)?"bg-green-300":"bg-yellow-300"]])}," Stockfish "+ne(Re(ai)?"running":"paused"),3),S("button",{onClick:t[0]||(t[0]=(...n)=>Re(mn)&&Re(mn)(...n)),class:"bg-secondary h-fit min-w-fit rounded-full py-1 px-4 text-white"}," ↻ Restart ")]),S("div",Ec,[S("p",zc,"Movetime: "+ne(Re(ft)),1),S("div",Ic,[Ta(S("input",{type:"range",min:"500",max:"10000","onUpdate:modelValue":t[1]||(t[1]=n=>Js(ft)?ft.value=n:null),class:"range range-secondary range-xs w-full"},null,512),[[Ha,Re(ft)]])])]),S("div",Fc,[ee(_c)]),S("div",Tc,[ee(Rc)])]))}};/*!
 * @kurkle/color v0.3.2
