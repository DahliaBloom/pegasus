var Ws=Object.defineProperty;var js=(i,e,t)=>e in i?Ws(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var O=(i,e,t)=>(js(i,typeof e!="symbol"?e+"":e,t),t);import{r as hi,_ as He,b as I,c as F,g as S,t as ne,y as $s,z as Ys,A as Zs,B as Us,w as Ta,v as Ha,d as Xs,F as gi,C as qs,p as Xi,n as Wa,l as Re,m as Js,i as ee,k as un,q as ec,h as _e}from"./index-45dfc6fc.js";import{c as tc,C as ic}from"./chess-d99999e1.js";import"./_commonjsHelpers-725317a4.js";let ni,at=0,Mi=null,ja="";const ai=hi(!1),ft=hi(3e3),Ot=hi([]);$a();function wi(i,e=!0){this.msg=i,this.stockfish=e}function $a(){console.log("Starting stockfish"),Stockfish().then(i=>{i.addMessageListener(ac),i.postMessage("uci"),i.postMessage("setoption name use nnue value true"),i.postMessage("setoption name Threads value 16"),i.postMessage("setoption name Hash value 128"),i.postMessage("setoption name UCI_AnalyseMode value true"),i.postMessage("ucinewgame"),ni=i,console.log("Stockfish started")})}function nc(i){switch(Ot.value.push(new wi(i)),i){case"uciok":ai.value=!0;break}}function ac(i){if(nc(i),console.log(i),i.startsWith("info depth")){const t=/ cp (-?\d+)/.exec(i);if(t===null){const c=/score mate (\d+)/.exec(i);at=parseFloat(c[1])*100}else at=parseFloat(t[1])/100;const a=/ pv (.+)/.exec(i);console.log("bestmove: "+a[1]),console.log("Pegasus Final Score: "+at),ja.split(" ")[1]=="w"?Mi(at,a[1]):Mi(-at,a[1])}}async function bn(i,e){ni===void 0&&e(0,"stockfish undefined"),ja=i,Qi(`position fen ${i}`),Qi(`go movetime ${ft.value}`),Mi=e}function mn(){ai.value=!1,$a()}function Qi(i){ni!==void 0?(Ot.value.push(new wi(i,!1)),ni.postMessage(i)):Ot.value.push(new wi("Stockfish not running"))}const qi={props:{evaluation:{type:Number,required:!0}},data(){return{height:50,heightString:"50%"}},methods:{update(){if(this.heightString=this.height+"%",console.log("update"),this.evaluation==="0.0"||this.evaluation==="0"){this.height=50,this.heightString=this.height+"%";return}let i=Number(this.evaluation);if(console.log("TMP:"+i),i>=100){this.height=100,this.heightString="100%";return}if(i<-100){this.height=0,this.heightString="0%";return}i>0&&(Math.abs(i)<1?(this.height=50+i*10,console.log("-1< x <1")):Math.abs(i)<3?(this.height=50+i*8,console.log("-3< x <3")):Math.abs(i)<6?(this.height=70+i*2,console.log("-6< x <6")):Math.abs(i)<11?(this.height=80+i,console.log("-9< x <9")):i>11&&(this.height=50+Math.log(Math.abs(i))*30)),i<0&&(Math.abs(i)<1?(this.height=50+i*10,console.log("-1< x <1")):Math.abs(i)<3?(this.height=50+i*8,console.log("-3< x <3")):Math.abs(i)<6?(this.height=30+i*2,console.log("-6< x <6")):Math.abs(i)<11?(this.height=20+i,console.log("-9< x <9")):i<-11&&(this.height=50-Math.log(Math.abs(i))*30)),this.height>96&&(this.height=96),this.height<4&&(this.height=4),this.heightString=this.height+"%"}},beforeMount(){this.update()},updated(){this.update()}},xn=()=>{$s(i=>({"2a52b7b8":i.heightString}))},pn=qi.setup;qi.setup=pn?(i,e)=>(xn(),pn(i,e)):xn;const sc=i=>(Ys("data-v-17365b00"),i=i(),Zs(),i),cc={class:"w-18 h-full flex flex-row flex-none px-3 items-center space-x-3"},oc=sc(()=>S("div",{class:"w-4 h-full relative flex-none rounded-lg"},[S("div",{class:"bg-black text-white text-center font-bold h-full rounded-lg"},[S("div",{class:"bg-white w-full text-center text-black absolute bottom-0 left-0 evalWhite rounded-b-lg transition-transform"})])],-1));function rc(i,e,t,n,a,s){return I(),F("div",cc,[S("span",null,ne(this.evaluation),1),oc])}const dc=He(qi,[["render",rc],["__scopeId","data-v-17365b00"]]),fc={props:{username:{type:String,required:!0},elo:{type:String,required:!0},color:{type:Boolean,required:!0}},data(){return{user:{name:"N",avatar:"/src/assets/magnusCarlsen.png"}}},beforeMount(){tc.getPlayer(this.username).then(i=>{this.user=i.body}).catch(()=>{isError.value=!0}).finally(()=>{console.log(this.user)})}},lc={class:"flex relative"},Nc=["src"],hc=["src"],gc={class:"flex flex-row items-baseline"},Bc={class:"text-xl font-bold"},uc={class:"text-xs px-3"};function bc(i,e,t,n,a,s){return I(),F("div",lc,[t.color?(I(),F("img",{key:0,class:"w-8 h-8 border-2 mr-2 rounded-lg",src:a.user.avatar,alt:"",style:{"border-color":"white"}},null,8,Nc)):(I(),F("img",{key:1,class:"w-8 h-8 border-2 mr-2 rounded-lg",src:a.user.avatar,alt:"",style:{"border-color":"black"}},null,8,hc)),S("div",gc,[S("h2",Bc,ne(a.user.username),1),S("p",uc,ne(this.elo),1)])])}const mc=He(fc,[["render",bc]]),xc={props:{evaluation:{type:Number,required:!0}},data(){return{height:40,styleString:"background: conic-gradient(#F741B8 36deg 60deg, #475569 36deg); border-radius: 50%;"}},methods:{update(){this.height=this.evaluation,this.styleString="background: conic-gradient(#F741B8 36deg "+360*(this.height/100)+"deg, #475569 36deg); border-radius: 50%;"}},beforeMount(){this.update()},updated(){this.update()}},pc=S("div",{class:"h-12 w-12 bg-base-100 rounded-full"},null,-1),Dc=[pc];function Oc(i,e,t,n,a,s){return I(),F("div",{class:"h-20 w-20 m-2 flex items-center justify-center",style:Us(a.styleString)},Dc,4)}const Vc=He(xc,[["render",Oc]]);function Cc(i){const t=`A00	Amar Gambit	1. Nh3 d5 2. g3 e5 3. f4 Bxh3 4. Bxh3 exf4
